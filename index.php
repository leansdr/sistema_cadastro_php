...
<div class="row">
	<div class="col s12 m8 push-m2">
		...
		<table class="striped">
			...
			<tbody>
				...
				<tr>
					...
					<!--<td><a href="" class="btn-floating red"><i class="material-icons">add_shopping_cart</i></a></td>-->
		...
		<br>
		<a href="adicionar.php" class="btn-floating red"><i class="material-icons">add</i></a>
	</div>
</div>
